...
class TestSmokeTest():
  ...
  def test_adminPageTest(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("test_incorrect_username")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("test_incorrect_password")
  ...
  def test_joinPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Test_FirstName")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Test_LastName")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Test_BusinessName")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Test_Position")
